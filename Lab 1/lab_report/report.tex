...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lcc@{}}
		...
		Purified & \textit{122--123} \si{\celsius} & \textit{X.X} \si{\celsius} \\
...
\textit{[Discuss your calculated percent recovery from Section~\ref{eq:recovery}. 
\begin{itemize}
	\item The percent recovery of Benzoic acid from crystalization is 58.7 percent, which is a reasonable yield. 
\end{itemize}]}
...
% - How close was the observed melting point to the literature value?
	The melting range is $123.0 - 122.0 = 1$ degree, which indicates high purity of benzoic acid. The observed melting point is very close to the literature value, which is 122.3 °C, also suggesting that the compound is pure benzoic acid.
